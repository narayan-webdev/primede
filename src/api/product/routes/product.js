...
import { create, find, simpleData, stats, productsByReview, shareProduct, importFromShopify, exportToExcel, catalouge, findOne, update, _delete, search, findByPrice, findNRandom, findNTrending, findNSelling, findNRandomInCategory, productImport } from "../controllers/product.js";
import { validateCreateBody, importFromShopify as _importFromShopify, validateUpdateBody, filterValidator } from "../middlewares/product.js";
